...
let tag = "✯"
const kayıtlı = message.guild.roles.cache.find(r => r.id === '752178449291935834')
const kayıtsız = message.guild.roles.cache.find(r => r.id === '752193453739343892')
...
.setColor('GREEN')
client.channels.cache.get('752197112699027547').send(embed)
