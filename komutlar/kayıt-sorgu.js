...
exports.run = async (client, message, args) => {
    ...
    if(!message.member.roles.cache.some(r => ["752193258268131460"].includes(r.id)) && (!message.member.hasPermission("ADMINISTRATOR")))
...
.setFooter(`Sander#Castle`) // evet bilerek kaldırmadım ayriyetten sıfırdan yazdım :)
